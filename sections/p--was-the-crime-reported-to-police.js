let output = {
  ...
  "properties": {
    ...
    "dont-know-if-crime-reported": {
      ...
      "const":
        "<gds-details title='I do not know if the crime was reported to the police' id='reported-help'>" +
        "<p>You can contact us for help with your application on 0300 003 3601. Select option 8.</p>" +
