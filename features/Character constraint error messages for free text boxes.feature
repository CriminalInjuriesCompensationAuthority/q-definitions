...
Feature: Character constraint error message for free text boxes
    ...
    Scenario Outline: Error message for free text boxes
        ...
        | p-applicant-have-you-applied-for-or-received-any-other-compensation       | q-applicant-applied-for-other-compensation-briefly-explain-why-not        | 500     | Explanation must be 500 characters or less                                          |
